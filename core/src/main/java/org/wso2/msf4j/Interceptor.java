...
public interface Interceptor {
     ...
     */
    boolean preCall(Request request, Response responder, ServiceMethodInfo serviceMethodInfo);
     ...
     */
    void postCall(Request request, int status, ServiceMethodInfo serviceMethodInfo);
}
