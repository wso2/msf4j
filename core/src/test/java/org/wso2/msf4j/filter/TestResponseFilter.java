...
/**
 * Test response filter for fat jar mode.
 */
public class TestResponseFilter implements MSF4JResponseFilter {

    private static AtomicInteger filterCalls = new AtomicInteger(0);
    private static final Logger log = LoggerFactory.getLogger(TestResponseFilter.class);
