...
/**
 * High priority request filter.
 */
@Priority(Priorities.AUTHENTICATION)
public class HighPriorityRequestFilter implements MSF4JRequestFilter {

    private static final Logger log = LoggerFactory.getLogger(HighPriorityRequestFilter.class);
