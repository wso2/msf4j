 ...
 */
@Component(
        name = "RequestInterceptorConfig",
        service = OSGiRequestInterceptorConfig.class,
        immediate = true
)
public class RequestInterceptorConfig extends OSGiRequestInterceptorConfig {

    @Activate
    protected void activate(BundleContext bundleContext) {
        addGlobalRequestInterceptors(new HTTPMonitoringInterceptor(), new MetricsInterceptor());
    }
}
