 ...
 *
 */
public class ServerDefinitionBuilder implements ServerBuilder {
    ...
    private static final Logger log = LoggerFactory.getLogger(ServerDefinitionBuilder.class);
     ...
     */
    public ServerDefinitionBuilder(int port) {
        ...
        if (server != null) {
            try {
                ...
                Runtime.getRuntime().addShutdownHook(new Thread(() -> {
                    ...
                    ServerDefinitionBuilder.this.stop();
                }));
            } catch (IOException e) {
